...
TEST_APK_PATH="/Users/netease/Documents/adam_wang/local_git/YX_GameCenter_RFUI/Resources/yixin_test.apk"
RFUI_TESTCASE="/Users/netease/Documents/adam_wang/local_git/YX_GameCenter_RFUI/Test/YX_Subscriptions"
#RFUI_TESTCASE="/Users/netease/Documents/adam_wang/local_git/YX_GameCenter_RFUI/Test/YX_Subscriptions/Game_Web"
RFUI_REP_DIR="/Users/netease/Documents/adam_wang/local_git/YX_GameCenter_RFUI/"
#RF_FILTER_TAGS is the include tags filter setting used by pybot command
RF_FILTER_TAGS="auto"
#RF_EXCLUDE_FILTER_TAGS is the exclude tags filter setting used by pybot command
RF_EXCLUDE_FILTER_TAGS="no_auto"
...
#2. run RF cases with xunit compatiable output.xml
    ...
    pyresult1=`pybot --outputdir ${FIRST_ROUND_OUTPUT_DIR} --nostatusrc --include=${RF_FILTER_TAGS}  --xunit=xunitOutput.xml ${RFUI_TESTCASE}`
    #pyresult1=`pybot --outputdir ${FIRST_ROUND_OUTPUT_DIR} --exclude=${RF_EXCLUDE_FILTER_TAGS}  --xunit=xunitOutput.xml ${RFUI_TESTCASE}`
    echo  "pyresult1: \n${pyresult1}\n"
